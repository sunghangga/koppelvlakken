class tmi_usrstop():
    def __init__(self):
        ...
        self.types = [
            ...
            {'name': 'QuayCode', 'aard': 'o', 'type': 'A', 'length': 10 },
            ]
    ...
    def parse(self, version, implicit, data_owner_code, elements):
        user_stop_code, timing_point_code, get_in, get_out, _, name, town, user_stop_area_code, stop_side_code, road_side_eq_data_owner_code, road_side_eq_unit_number, minimal_stop_time, stop_side_length, description, user_stop_type, quay_code = elements
        if stop_side_code == '-':
            stop_side_code = ''
        self.data.append([version, implicit, data_owner_code, user_stop_code, timing_point_code, get_in, get_out, name, town, user_stop_area_code, stop_side_code, road_side_eq_data_owner_code, road_side_eq_unit_number, minimal_stop_time, stop_side_length, description, user_stop_type, quay_code])
