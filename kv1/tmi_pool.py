class tmi_pool():
    def __init__(self):
        ...
        self.types = [
            ...
            {'name': 'LinkValidFrom', 'aard': 'o', 'type': 'D', 'length': 10 },
        ...
        # self.references = {'point': ['PointCode'],
        #                    'link': ['UserStopCodeBegin', 'UserStopCodeEnd', 'TransportType']}

        # Bug, can't references to link table
        self.references = {'point': ['PointCode']}
